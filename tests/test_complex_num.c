...
void test_creation(int*, int*);
void test_equality(int*, int*);
void test_parsing(int*, int*);
void test_pure_real(int* p, int* f);
void test_pure_imaginary(int* p, int* f);
void test_addition(int* p, int* f);
void test_subtraction(int* p, int* f);
void test_scalar_multiplication(int* p, int* f);
void test_complex_multiplication(int* p, int* f);
void test_conjugate(int* p, int* f);
...
void test_creation(int *p, int* f)
{
...
void test_equality(int* p, int* f)
{
...
void test_argument(int* p, int* f) 
{
