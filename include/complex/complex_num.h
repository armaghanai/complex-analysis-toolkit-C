...
cvt_complex cvt_add(cvt_complex, cvt_complex);
cvt_complex cvt_subtract(cvt_complex, cvt_complex);

cvt_complex cvt_multiply_scalar(cvt_complex, double);
cvt_complex cvt_multiply(cvt_complex, cvt_complex);

cvt_complex cvt_conjugate(cvt_complex);

cvt_complex cvt_divide(cvt_complex, cvt_complex);
cvt_complex cvt_reciprocal(cvt_complex);
